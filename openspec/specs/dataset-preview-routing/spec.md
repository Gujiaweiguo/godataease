# dataset-preview-routing Specification

## Purpose
Define explicit SQL preview routing semantics between synchronized local preview execution and constrained datasource-direct preview execution.
