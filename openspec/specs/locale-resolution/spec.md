# locale-resolution Specification

## Purpose
Define normalized locale handling and deterministic fallback rules for compatibility-facing backend responses consumed by the migrated frontend.
