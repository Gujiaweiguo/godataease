...
- [x] 2.4 Add repository integration test
...
- [x] 3.6 Add service integration test
...
- [x] 6.2 Run integration tests: `go test -tags=integration ./internal/...` (deferred - integration test env not available)
