...
func TestDataFillingHandler_RegisterRoutesIncludesDMLEndpoints(t *testing.T) {
	...
	assert.True(t, routes["GET /data-filling/form/:formId/excelTemplate"])
	assert.True(t, routes["POST /data-filling/form/:formId/uploadFile"])
	assert.True(t, routes["POST /data-filling/form/:formId/confirmUpload"])
	assert.True(t, routes["POST /data-filling/form/extraDetails"])
	assert.True(t, routes["POST /data-filling/form/:formId/options"])
	assert.True(t, routes["GET /data-filling/template/:itemId"])
	assert.True(t, routes["POST /data-filling/innerExport/:isDataEaseBi/:formId"])
