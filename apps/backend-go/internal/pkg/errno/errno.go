...
// Shared error message constants used across packages.
const (
	ErrInvalidTableName               = "invalid table name"
	ErrInvalidColumnName              = "invalid column name"
	ErrInvalidDatasetID               = "invalid dataset id"
	ErrInvalidDatasourceID            = "invalid datasource id"
	ErrDatasourceConfigEmpty          = "datasource configuration is empty"
	ErrDatasourceNameExists           = "datasource name already exists"
	ErrDatasetNameExists              = "dataset name already exists"
	ErrFileSizeExceedsLimit           = "file size exceeds 10MB limit"
	ErrRepositoryUnavailable          = "repository is unavailable"
	ErrRepositoryNotInitialized       = "repository not initialized"
	ErrServiceNotConfigured           = "service is not configured"
	ErrIDRequired                     = "id is required"
	ErrChartIDRequired                = "chart id is required"
	ErrDatasetIDRequired              = "dataset id is required"
	ErrDatasourceIDRequired           = "datasource id is required"
	ErrDatasetNameRequired            = "dataset name is required"
	ErrDatasourceNameRequired         = "datasource name is required"
	ErrSQLRequired                    = "sql is required"
	ErrOrgIDRequired                  = "org id is required"
	ErrInvalidUserContext             = "invalid user context"
	ErrInvalidOrgContext              = "invalid org context"
	ErrResourcePermNotInitialized     = "resource permission service not initialized"
	ErrDatasourceRepoUnavailable      = "datasource repository is unavailable"
	ErrDatasetRepoUnavailable         = "dataset repository is unavailable"
	ErrDatasourceNotFound             = "datasource not found"
	ErrDatasetNotFound                = "dataset not found"
	ErrOrganizationNotFound           = "organization not found: %w"
	ErrUserNotFound                   = "user not found: %w"
	ErrRoleNotFound                   = "role not found: %w"
	ErrFailedHashPassword             = "failed to hash password: %w"
	ErrTokenGeneratorNotConfigured    = "token generator is not configured"
	ErrSeatunnelNotInitialized        = "seatunnel client not initialized"
	ErrUserImportServiceNotConfigured = "user import service is not configured"
	ErrUserServiceNotConfigured       = "user service is not configured"
	ErrRoleRepoNotConfigured          = "role repository is not configured"
	ErrOrgRepoNotConfigured           = "org repository is not configured"
	ErrDatasourceRepoNotConfigured    = "datasource repository is not configured"
)
