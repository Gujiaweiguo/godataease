...
type DataPermRow struct {
	...
	DatasetID      int64      `gorm:"column:dataset_id;not null" json:"datasetId"`
	DatasetGroupID int64      `gorm:"column:dataset_group_id;not null" json:"datasetGroupId"`
	...
	WhiteListUser  string     `gorm:"-" json:"whiteListUser"`
	WhiteListRole  string     `gorm:"-" json:"whiteListRole"`
	WhiteListDept  string     `gorm:"-" json:"whiteListDept"`
